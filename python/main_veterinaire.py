def veterinaire(conn):
	...
	while(choix):
	    ...
	    print('14 - Afficher le traitement actuel d un animal')
		...
		######################################
		    ...
		    nv_duree=input("Quelle est la nouvelle durée de ce traitement ?")
			idtraitement=input("Quel est l'identifiant du traitement ?")
		    update_traitement(conn, nv_duree, idtraitement)
